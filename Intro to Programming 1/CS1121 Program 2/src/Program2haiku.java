public class Program2haiku {
	...
	public String[] haikuVerbs = {
			" go ", "come" , "calm" ,"end", "stop" , 
	};
	
	public String[] haikuNouns = {
			"seasons", "winters" , "summers", "weekdays" , "workdays"
	};
	
	public String[] haikuAdjectives = {
		"happy", "angry", "peaceful", "chilly", "dreary",
	};
   ...
   */
   public String generateThematicPoem( Theme theme ) {
	...
	public String generateRandomHaiku(haikuTheme haikuTheme) {
		...
		if ( haikuTheme == Program2haiku.haikuTheme.pleasant ) {
		...
		if ( haikuTheme == Program2haiku.haikuTheme.bitter ) {
	...
	public static void main(String[] args) {
		Program2haiku obj = new Program2haiku();
